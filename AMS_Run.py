    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"D:\project\Attendance\Manually Attendance\-------Check atttendance-------"')
        ...
        try:
            ...
            while (True):
                ...
                for (x, y, w, h) in faces:
                    ...
                    cv2.imwrite("D:/project/TrainingImage/ " + Name + "." + Enrollment + '.' + str(sampleNum) + ".jpg",
                                gray)
    ...
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    recognizer.read("D:\project\TrainingImageLabel\Trainner.yml")
                except:
                ...
                df = pd.read_csv("D:\project\StudentDetails\StudentDetails.csv")
                cam = cv2.VideoCapture(0)
...
def trainimg():
    ...
    global detector
    detector = cv2.CascadeClassifier("D:\project\haarcascade_frontalface_default.xml")
    try:
        global faces, Id
        faces, Id = getImagesAndLabels("D:\project\TrainingImage")
    except Exception as e:
